...
?>
    ...
    <head>
        ...
        <!-- 參考資料與圖片來源:(僅供用於學習資料使用，不會有商業行為)
        Wendels 温德德式烘焙餐館 http://www.wendels-bakery.com/zh-tw
        https://jibaoviewer.com/project/577dc9153b1ef6f73923efa0
        http://wooden-boat-plans.info/chocolate-ganache-tart-with-strawberries-bea2d.html
        https://www.mobydisc.de/en/wedding-cake.htm
        https://wedition.co.uk/blog/2018-08-01-top-tips-for-the-perfect-summer-wedding-cake
        https://www.pexels.com/photo/closeup-photo-of-red-and-orange-petaled-flower-784210/ -->
        ...
        <div id="top">
            <div class="container">
                <div class="col-md-6 offer" data-animate="fadeInDown">
                    ...
                    <a href="frontend/register.php">立即取得200元購物金!</a>
                </div>
                <div class="col-md-6" data-animate="fadeInDown">
                    <ul class="menu">
                        <?php if(isset($_SESSION['member']) && $_SESSION['member'] !=null) { ?>
                        <li>
                            <a href="frontend/customer-account.php">會員專區</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="frontend/register.php">加入會員</a>
                        </li>
                        <?php } ?>
                        <li>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navigation">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li>
                            <a href="frontend/about.php">關於我們</a>
                        </li>
                        <li>
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="col-md-12">
                        <div id="main-slider">
                            <div class="item">
                                <img class="img-responsive" src="images/main-slider1.jpg" alt="">
                            </div>
                            <div class="item">
                        ...
                        <div class="same-height-row">
                            ...
                            <div class="col-sm-4">
                                <div class="box same-height clickable">
                                    ...
                                    <p>嚴選食材原料、精確烘焙比例、堅持製作工序
                                    <br>只為了讓每位嚐到新鮮又健康充滿幸福的美食
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="blog-homepage" class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="post">
                                    ...
                                    <hr>
                                    <p class="intro">
                                        <?php echo mb_strimwidth(strip_tags($news['content']),0,100,"..."); ?>
                                    </p>
                                    <p class="read-more">
                                        <a href="frontend/news.php?id=<?php echo $news['news_id']; ?>" class="btn btn-primary">了解更多</a>
                                    </p>
                                </div>
                            </div>
                            <?php } ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            ...
                            <ul>
                                <li>
                                    <a href="frontend/shopping_rules.php">購物須知</a>
                                </li>
                                <li>
                                    <a href="frontend/faq.php">常見問題</a>
                                </li>
                                <li>
                                    <a href="frontend/contact.php">聯絡我們</a>
                                </li>
                ...
                <div class="container">
                    ...
                    <div class="col-md-6">
                        <p class="pull-right">Designed by
                            <a href="frontend/https://bootstrapious.com/e-commerce-templates">Mila
