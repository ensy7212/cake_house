                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <p><strong>106 台北市大安區
                                <br>敦化南路一段165巷50號</strong></p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                                <h3><i class="fa fa-phone"></i> 客服中心</h3>
                                <p class="text-muted">週一至週五<strong>0900-1800</strong></p>
                                <p><strong>客服專線:</strong></p>
                                <p><strong>02-2588-6019*107</strong></p>
                            </div>
                            <!-- /.col-sm-4 -->
                            <div class="col-sm-4">
                                
                                <h3><i class="fa fa-envelope"></i> 線上客服</h3>
                                <p class="text-muted">有任何問題請來信寄到以下郵件，
                                <br>我們會於平日上班時間，
                                <br>盡快回覆您的問題</p>
                                <strong><a href="mailto:">service@cakehouse.com</a></strong>
