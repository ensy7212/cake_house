          ...
          <div class="col-md-12">
            <form class="" action="edit.php" method="post" id="Form" data-toggle="validator">
              <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="published_date" id="published_date" value="<?php echo $news['published_date']; ?>" data-error="請選擇發佈日期" required>
              ...
              <div class="form-group form-row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="title" value="<?php echo $news['title']; ?>" data-error="請輸入標題" required>
                  <div class="help-block with-errors text-left alert-danger"></div>
              </div>
          </div>
              <div class="form-group form-row">
